...
"""Build tar.gz for github-indicator.
...
setup(
    ...
    description = 'GitHub status and notifications indicator.',
    long_description = 'Indicator applet that monitors GitHub status and show notications from GH activitis.',
    url = 'https://github.com/gepatino/github-indicator',

    packages = ["ghindicator"],
    package_data = {"ghindicator": ["icons/*.png"]},
    scripts = ["bin/github-indicator"],
